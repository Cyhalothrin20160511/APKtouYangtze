  ...
  return (
      <nav data-bs-theme="dark">
        ...
        <div className="navbar navbar-dark bg-dark shadow-sm">
          <div className="container">
            <Link href="/" className="navbar-brand d-flex align-items-center" style={{ wordWrap: "break-word", overflowWrap: "break-word", whiteSpace: "normal", wordBreak: "break-all" }}>
              <Image src={logo} alt="Logo" width="40" height="40" style={{ marginRight: "10px" }} />
