      ...
      <div className="position-relative overflow-hidden p-3 text-center">
          ...
          {article.image_url && (
            <>
              <img
                ...
                alt={article.title}
                style={{ maxWidth: '60%', height: 'auto', margin: '0 auto' }}
              />
              <p className="text-body-secondary" style={{ whiteSpace:'pre-wrap', maxWidth:'80%', margin:'1rem auto', wordBreak:'break-word' }}>
        ...
        <footer className="text-body-secondary">
          <div className="container d-flex justify-content-end align-items-center mb-3">
            ...
            <Link href={`/${lang}/songjiang/articles/1`}>
